...
@section('content')
    <div class="row">
        <div class="col-12 col-xl-8 mb-4 mb-xl-0">
            ...
            <h3 class="font-weight-bold">Tambah Event Baru</h3>
        </div>

            <div class="col-12 grid-margin mt-3 stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Form Daftar Event</h4>
                    <p class="card-description">form dengan label <span>*</span> wajib diisi</p>
                    <form class="forms-sample" method="POST" action="{{ route('penyelenggara.event.store') }}" enctype="multipart/form-data">
                        @csrf
                      <div class="form-group">
                        <label for="exampleInputName1">*Nama Event</label>
                        <input type="text" name="nama_event" value="{{ old('nama') }}" class="form-control" id="exampleInputName1" placeholder="Name" required>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="row">
                        <div class="col-lg-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="datetimepicker1" name="jadwal_mulai"/>
                            </div>
                        </div>
                        <div class="col-lg-6 col-12">
                            <div class="form-group">
                                <label for="datetimepicker2">*Tanggal Selesai</label>
                                <input type="text" class="form-control" id="datetimepicker2" name="jadwal_selesai"/>
                            </div>
                        </div>
                      </div>
                      <div class="form-group">
